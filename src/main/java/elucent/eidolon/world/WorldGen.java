...
import elucent.eidolon.world.stuctures.CatacombPieces;
import elucent.eidolon.world.stuctures.CatacombStructure;
import elucent.eidolon.world.stuctures.LabStructure;
import elucent.eidolon.world.stuctures.StrayTowerStructure;
...
public class WorldGen {
    ...
    static RegistryObject<ConfiguredStructureFeature<NoneFeatureConfiguration, ? extends StructureFeature<NoneFeatureConfiguration>>> registerC(Supplier<ConfiguredStructureFeature<NoneFeatureConfiguration, ? extends StructureFeature<NoneFeatureConfiguration>>> type, String name) {
    ...
    public static RegistryObject<ConfiguredStructureFeature<NoneFeatureConfiguration, ? extends StructureFeature<NoneFeatureConfiguration>>> LAB_FEATURE, STRAY_TOWER_FEATURE, CATACOMB_FEATURE;
    ...
    public static void init() {
        ...
        if (Config.STRAY_TOWER_ENABLED.get()) {
