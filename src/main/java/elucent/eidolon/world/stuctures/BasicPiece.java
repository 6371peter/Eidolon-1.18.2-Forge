...
public class BasicPiece extends TemplateStructurePiece{
    ...
    public BasicPiece(StructurePieceType structurePieceTypeIn, ResourceLocation key, CompoundTag nbt, StructureManager manager) {
        super(structurePieceTypeIn, nbt, manager, (r) -> (new StructurePlaceSettings()
        ...
        var part = manager.getOrCreate(key);
        this.template = manager.get(key).get();
    }
